...
#, load_data, prepare_mnist_data, input_mnist_data, ensure_integer_labels, load_data_from_db, transform_data_to_numpy, load_trained_model, predict, save_predictions_to_db, convert_to_true_labels
